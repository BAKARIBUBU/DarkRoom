...
const Movie = () => {
  ...
  return (
    ...
    <div
      ...
      style={{
        backgroundImage: "url('data:image/jpeg;base64,...')",
      }}
    ></div>
    
    {/* Welcome Banner */}
    <div className="h-96 flex justify-center items-center text-center text-white">
      ...
      <div className="flex overflow-x-scroll gap-6 scrollbar-hide">
        {movies.map((movie) => (
          <div
            ...
            className="relative w-64 cursor-pointer transform transition-transform hover:scale-105"
          >
            <img
    ...
    <button
      className="bg-pink-600 text-white px-6 py-3 rounded-full mt-8 mx-auto block hover:bg-pink-700 transition-colors"
      onClick={() => setShowForm(!showForm)}
      aria-label="Toggle Add New Movie Form"
    >
...
//             onClick={() =>
//               document.querySelector(".movies-wrapper .flex").scrollBy({ left: -200, behavior: "smooth" })
//             }
//           >
//             ◀
//           </button>
...
//         <form
//           onSubmit={handleSubmit}
//           className="bg-white p-6 mt-8 mx-auto max-w-md rounded-lg shadow-lg"
//         >
//           <div className="mb-4">
...
//           <button
//             type="submit"
//             className="bg-teal-600 text-white px-6 py-3 rounded-full mt-4 w-full"
//           >
//             Add Movie
//           </button>
//         </form>
