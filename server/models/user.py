...
class User(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-_password_hash','-posts','-comments','-ratings','-club_users','-followers','-following',)
...
#         '-followers',
#         '-following',
#         '-movies',  # Exclude movies by default if needed
#     )
